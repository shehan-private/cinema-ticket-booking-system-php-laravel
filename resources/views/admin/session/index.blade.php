<x-app-layout>
    @section('content')
        ...
        <div class="card card-success m-3">
            ...
            <table class="m-3 table table-bordered table-striped dataTable dtr-inline" id="sessions_today">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Date</th>
        ...
        <div class="card card-primary m-3">
            ...
            <table class="m-3 table table-bordered table-striped dataTable dtr-inline" id="sessions_schedule">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Date</th>
        ...
        <div class="card card-secondary m-3">
            ...
            <table class="m-3 table table-bordered table-striped dataTable dtr-inline" id="sessions_complete">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Date</th>
